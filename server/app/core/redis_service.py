...
class RedisServiceLogger:
    LOGGER_NAME = "RedisService"
    _logger = None
...
class RedisService:
    def __init__(self):
        self.logger = RedisServiceLogger.get_logger()
    ...
    async def start_listening(self):
        ...
        try:
            ...
            self.logger.info("Redis listener cancelled")
        except Exception as e:
            self.logger.error(f"Redis listener crashed: {e}")
