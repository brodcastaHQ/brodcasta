    ...
    return (
        <header className="h-16 border-b border-base-200 bg-base-100 flex items-center justify-between px-6 sticky top-0 z-10">
            ...
            <div className="flex items-center gap-4">
                <button className="lg:hidden btn btn-ghost btn-square btn-sm">
                    <Menu size={20} />
                </button>
            ...
            <div className="flex items-center gap-3">
                <button className="btn btn-ghost btn-sm gap-2 font-normal text-base-content/70">
                    <Search size={16} />
                ...
                <button className="btn btn-ghost btn-square btn-sm text-base-content/70">
                    <HelpCircle size={18} />
                </button>

                <div className="divider divider-horizontal mx-1 my-3"></div>

                <button className="btn btn-circle btn-sm bg-neutral text-neutral-content text-xs font-medium">
                    CD
                </button>
            </div>
        </header>
